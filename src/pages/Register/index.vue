  ...
  <div>
    <div class="register">
      ...
      <div class="content">
        ...
        />
        <button
          style="width: 100px; height: 38px; marginleft: 5px"
          @click="getCode"
        >
          获取验证码
        </button>
      ...
      <div class="content">
        ...
        <input
          type="password"
          placeholder="登录密码(8-18位,密码必须含字母或数字)"
          v-model="password"
          name="password"
          v-validate="{ required: true, regex:/^(?=.*[A-Za-z0-9])[^]{8,18}$/}"
      ...
      <div class="btn">
        <button @click="userRegiser">完成注册</button>
      </div>
    </div>
