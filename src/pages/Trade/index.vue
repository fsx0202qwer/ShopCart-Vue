  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="order in oderInfo.detailArrayList"
          :key="order.skuId"
        >
          <li>
            <img
    ...
    <div class="money clearFix">
      <ul>
        <li>
          <b
            ><i>{{ oderInfo.totalNum }}</i
            >件商品，总商品金额</b
          >
          <span>¥{{ oderInfo.totalAmount }}.00</span>
        </li>
        <li>
          <b>返现：</b>
          <span>0.00</span>
    ...
    <div class="trade">
      <div class="price">
        应付金额:<span>¥{{ oderInfo.totalAmount }}.00</span>
      </div>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      oderInfo: (state) => state.trade.oderInfo,
    }),
    //提交订单最终选中的地址
    userDefaultAddress() {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        ...
        orderDetailList:this.oderInfo.detailArrayList, // 商品信息
      };
